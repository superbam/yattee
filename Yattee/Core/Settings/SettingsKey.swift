...
enum SettingsKey: String, CaseIterable {
    ...
    // Which tab of that instance's browse screen to open on.
    case tabBarStartupInstanceTab
    ...
    // Which tab of that instance's browse screen to open on.
    case sidebarStartupInstanceTab
